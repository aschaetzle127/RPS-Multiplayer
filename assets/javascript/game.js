$(document).ready(function() {
    var config = {
      ...
      firebase.initializeApp(config);
        ...
        var player1Ref = dBase.ref("/players/player1");
        var player2Ref = dBase.ref("/players/player2");
        ...
        $("#login").click(function(e) {
            ...
            //currentPlayers = dBase(playersRef.numChildren());
            //player1 = snap.val()[1];
            //player2 = snap.val()[2];
            //console.log('snap',snap.val()[1]);
